...
export default function Home() {
    ...
    const [todos, setTodos] = useState([
        ...
        { id: 3, text: "Plan sprint goals", completed: false },
    ]);
        ...
        <>
            ...
            <section style={{ marginBottom: 48 }} className="anim-fade-in-up anim-delay-4">
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
                    <h2 className="section-title" style={{ margin: 0 }}>To-Do List</h2>
                ...
                {/* Progress bar */}
                {todos.length > 0 && (
                    <div className="progress-bar-track" style={{ marginBottom: 20, height: 6 }}>
                        <div
                ...
                <div className="glass-card-static" style={{ padding: 24 }}>
                    ...
                    <div style={{ display: "flex", gap: 10, marginBottom: 20 }}>
                        ...
                        />
                        <button onClick={addTodo} className="btn-primary" style={{ flexShrink: 0 }}>
                        ...
                        {todos.map((todo) => (
                            <div
                                ...
                                style={{
                                    ...
                                    gap: 12,
                                    padding: "12px 16px",
                                    background: todo.completed ? "rgba(52,211,153,0.04)" : "rgba(255,255,255,0.03)",
                                    border: `1px solid ${todo.completed ? "rgba(52,211,153,0.12)" : "var(--border-subtle)"}`,
